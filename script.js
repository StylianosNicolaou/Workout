document.addEventListener("DOMContentLoaded", function () {
  ...
  if (!firebase.apps.length) {
    ...
    console.log("🔥 Firebase initialized securely on Vercel!");
  } else {
    firebase.app();
  }

  // ✅ Now we can safely call Firebase services
  const auth = firebase.auth(); // ✅ Define auth AFTER Firebase is initialized
